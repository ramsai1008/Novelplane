// History.js: Show user's reading history grouped by novel
...
export default function History() {
  ...
  if (!user) return <div className="p-4">Please log in to view your reading history.</div>;
        ...
        <ul className="space-y-4">
          {sortedNovels.map(([novelId, entry]) => (
            <li key={novelId} className="border p-4 rounded shadow">
              ...
              <Link
                to={`/read/${novelId}/${entry.chapterId}`}
